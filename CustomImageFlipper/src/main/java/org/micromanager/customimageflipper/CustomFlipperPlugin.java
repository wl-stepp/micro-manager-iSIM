...
public class CustomFlipperPlugin implements ProcessorPlugin, SciJavaPlugin {
   ...
   public ProcessorConfigurator createConfigurator(PropertyMap settings) {
      return new CustomFlipperConfigurator(studio_, settings);
   }

   @Override
   public ProcessorFactory createFactory(PropertyMap settings) {
      return new CustomFlipperFactory(settings, studio_);
   }
