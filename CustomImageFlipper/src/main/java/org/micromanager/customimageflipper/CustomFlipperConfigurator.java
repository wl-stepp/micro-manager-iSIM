...
public class CustomFlipperConfigurator extends JFrame implements ProcessorConfigurator {
   ...
   private static final List<Integer> R_INTS =
      Arrays.asList(new Integer[] {CustomFlipperProcessor.R0,
         CustomFlipperProcessor.R90, CustomFlipperProcessor.R180, CustomFlipperProcessor.R270});
   ...
   public CustomFlipperConfigurator(Studio studio, PropertyMap settings) {
      studio_ = studio;
      ...
      Integer rotation = settings.getInteger("rotation",
            defaults_.getInteger(DEFAULT_ROTATION, CustomFlipperProcessor.R0));
   ...
   public void setMirror(boolean mirror) {
      mirrorCheckBox_.setSelected(mirror);
   }
   ...
   public void setRotation(int rotation) {
      rotateComboBox_.setSelectedIndex(rotation);
   }
   ...
   public final int getRotate() {
      if (R90.equals((String) rotateComboBox_.getSelectedItem())) {
         return CustomFlipperProcessor.R90;
      }
      if (R180.equals((String) rotateComboBox_.getSelectedItem())) {
         return CustomFlipperProcessor.R180;
      }
      if (R270.equals((String) rotateComboBox_.getSelectedItem())) {
         return CustomFlipperProcessor.R270;
      }
      return CustomFlipperProcessor.R0;
   }
   ...
   private void processExample() {
      ...
      testImage = CustomFlipperProcessor.transformImage(studio_, testImage,
            getMirror(), getRotate());
